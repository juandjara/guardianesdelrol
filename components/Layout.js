...
export default function Layout ({ children, title = 'Guardianes del Rol', className }) {
  return (
    <div className="flex flex-col text-white h-screen">
      <Head>
        <meta name="theme-color" content="#c0392b" />
        <meta name="description" content="Portal para organizar las partidas de rol de la asociación Guardianes de Sevilla" />
        <title>{title}</title>
      </Head>
      ...
      <footer className="p-3 flex flex-col md:flex-row md:items-end md:justify-between">
        <div className="">
          ...
          <p>creado por <a href="https://juandjara.com">juandjara</a></p>
          <p>
